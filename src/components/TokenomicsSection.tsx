  ...
  return (
    <section id="tokenomics" className="signal-section bg-gradient-to-b from-card/20 to-background">
      <div className="signal-container">
        ...
        {/* Utility & Value Flow */}
        <div className="mb-16">
          <h3 className="text-2xl md:text-3xl font-bold mb-12 text-center">Utility & Value Flow</h3>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {valueFlow.slice(0, 3).map((flow, index) => {
              const Icon = flow.icon;
              return (
                <div key={index} className="signal-card hover:signal-glow transition-all duration-300">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-6 max-w-4xl mx-auto">
            {valueFlow.slice(3).map((flow, index) => {
              const Icon = flow.icon;
              return (
                <div key={index + 3} className="signal-card hover:signal-glow transition-all duration-300">
                  <div className="flex items-center mb-4">
                    <div className="p-3 bg-primary/10 rounded-xl mr-3">
                      <Icon className="text-primary" size={20} />
                    </div>
